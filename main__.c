...
int main(void)
{
    ...
    int size = (int)(music.stream.sampleSize);
    ...
    SetConfigFlags(FLAG_FULLSCREEN_MODE | FLAG_WINDOW_ALWAYS_RUN | FLAG_MSAA_4X_HINT);
    ...
    while (!WindowShouldClose())
    {
        ...
        DrawRectangle(0, screenHeight - (screenHeight/24), screenWidth, (screenHeight/24), Fade(DARKGRAY, 0.5f));
        DrawRectangle(0, screenHeight - (screenHeight/24), (int)timePlayed, (screenHeight/24), BLACK);
